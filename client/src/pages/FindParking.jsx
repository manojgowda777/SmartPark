                ...
                <div className="flex-1">
                    ...
                    <div className="flex justify-between items-end mb-8">
                        ...
                        <div className="flex bg-white rounded-xl shadow-sm border border-slate-200 p-1">
                            <button onClick={() => setViewMode('both')} className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${viewMode === 'both' ? 'bg-slate-100 text-slate-900 shadow-inner' : 'text-slate-500 hover:text-slate-700'}`}>{t.split}</button>
                            <button onClick={() => setViewMode('map')} className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${viewMode === 'map' ? 'bg-slate-100 text-slate-900 shadow-inner' : 'text-slate-500 hover:text-slate-700'}`}><MapIcon size={16}/> {t.map}</button>
                            <button onClick={() => setViewMode('list')} className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${viewMode === 'list' ? 'bg-slate-100 text-slate-900 shadow-inner' : 'text-slate-500 hover:text-slate-700'}`}><List size={16}/> {t.list}</button>
                        </div>
                    </div>
